...
| Jesus David Zabala Grateron | Desarrollador | `DAV1D-17` |
...
* **Comunicación Oficial y Archivos:** Gmail Google
* **Urgencias o bloqueos rápidos:** WhatsApp
...
* **Reuniones de Sincronización (Daily Stand-up):** Nos reuniremos los días domingo y viernes a las Domingo: 2 pm y Viernes: 9 am de forma Virtual.
* **Tiempo máximo de respuesta:** Nos comprometemos a responder mensajes del equipo en un máximo de 24 horas durante el horario hábil.
...
* **Regla del Bloqueo (Timeboxing):** Si un desarrollador lleva más de 6 dias atascado en el mismo error, **debe** levantar la mano y pedir ayuda al equipo. No se permite perder semanas enteras en silencio.
